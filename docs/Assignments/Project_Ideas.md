...
There are established [python notebooks which can run on Google Colab](https://colab.research.google.com/github/sokrypton/ColabFold/blob/main/AlphaFold2.ipynb) allow you to provide your own running of these analysis. Develop a simple python notebook to fold a structure of a protein you are interested in.
...
Untranslated lengths across the species. This is generating summary statistics about annotated genes.
...
adaptations (thermophilic vs halophilic).

2. Examine the differences in Protein domain distribution between species.

## Team Russian Doll

1. Many organisms have undetected symbionts of bacteria or
...
phage). Or develop a pipeline to look at assembled eukaryotic genomes
