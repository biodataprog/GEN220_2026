...
Format of the report can be as PDF or Markdown in the github or submitted separately to me. You can also write this in google docs. Whatever you feel most comfortable in.
...
Include a link to the github repository. If you developed multiple scripts or steps to solve your problem, provide an explanation of what these are.
...
You can or should include PDFs or figures and tables (TSV or CSV files) in the github repository if that makes sense.

# Discussion

What did your project uncover regarding the question(s) you set out to answer? This should match in some way the questions outlined in the Introduction. If you could not achieve all your objectives, please describe the ones you could and give an update on what you would continue on if you had more time or could solve any roadblocks.

Describe any pitfalls, things that didn't work. If you had more time describe other ways you would complete or expand the project.

# References

Helpful to list as citations the methods/tools you used.  I recommend paperpile but any simple citations are fine.
