...
7. [Saccharomyces Genome Database](https://yeastgenome.org/)
8. [TAIR](http://arabidopsis.org)
9. [Gramene](https://www.gramene.org/) - Plant Comparative Resources
10. [Phytozome](https://phytozome.jgi.doe.gov/) - Plant Comparative Genomics portal
11. [UCSC Genome Browser](https://genome.ucsc.edu/cgi-bin/hgGateway)
...
To visualize genome annotation combined with Epigenomic, Transcriptomic, or Variant data you want to visualize them onto a genome browser.  [JBrowse](https://jbrowse.org) provides an easy to setup tool for this visualization.
...
The next directions are specific to the UCR HPCC. These instructions use an already built conda environment which you can link to:
...
zgrep "^#" NC_045512.gff.gz > NC_045512.sorted.gff
...
BAM and CRAM files need to have been indexed
...
Now navigate to the web with your link based on your username and folder - this would look like this but you need to put your username  `http://cluster.hpcc.ucr.edu/~USERNAME/private/jbrowse2/SARS-CoV-2`
