...
The output file by default will be the date of the analysis. Opening the file `cyanobacteria/Results_XXX/Orthogroups.txt` but I made a [folder](https://github.com/biodataprog/GEN220_2020_examples_2021/blob/main/Orthologs/cyanobacteria/OrthoFinder/Results/Orthogroups/) in the examples you can look over. Here's one [table](https://github.com/biodataprog/GEN220_2020_examples_2021/blob/main/Orthologs/cyanobacteria/OrthoFinder/Results/Orthogroups/Orthogroups.tsv)
...
The tool also generates [summary statistics](https://github.com/biodataprog/GEN220_2020_examples_2021/tree/main/Orthologs/cyanobacteria/OrthoFinder/Results/Comparative_Genomics_Statistics) we can look through.

Could write a script to turn this into a table or use the [summary count table](https://github.com/biodataprog/GEN220_2020_examples_2021/blob/main/Orthologs/cyanobacteria/OrthoFinder/Results/Orthogroups/Orthogroups.GeneCount.tsv) provided.
