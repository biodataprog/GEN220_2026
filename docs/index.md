...
* [Git and GitHub guide](Resources/Git_tutorial) and [Software Carpentry Github Tutorial](http://swcarpentry.github.io/git-novice/)
...
* [Bioinformatics](Bioinformatics) analysis methods
* Editors
...
* HW5 - [GitHub Website](Assignments/HW5) [PDF](Assignments/HW5.pdf)

# Project
* 2026 Project ideas [2026 Project Topics](Assignments/Project_Topics) [PDF](Assignments/Project_Topics.pdf)
...
1. [Bioinformatics: Workshop - SNPs per gene and splice sites](Bioinformatics/Workshop_SNPs) [PDF](Bioinformatics/Workshop_SNPs.pdf)
...
1. [Bioinformatics: Workshop - orthologs and gene networks](Bioinformatics/Workshop_networks) [PDF](Bioinformatics/Workshop_networks.pdf)
1. [Bioinformatics: Phylogeny and Gene Families](Bioinformatics/Phylogeny_families) [PDF](Bioinformatics/Phylogeny_families.pdf)
1. [Bioinformatics: Sequence Evolution and Statistics](Bioinformatics/Sequence_evolution) [PDF](Bioinformatics/Sequence_evolution.pdf)
1. [Bioinformatics: Microbiome](Bioinformatics/Microbiome_data) [PDF](Bioinformatics/Microbiome_data.pdf)
1. [Bioinformatics: Genome Browsers](Bioinformatics/Genome_Browsers) [PDF](Bioinformatics/Genome_Browsers.pdf)
